    ...
    for rec in history_raw:
        if isinstance(rec, dict):
            population_history.append({k: rec.get(k) for k in (
                ...
                "archive_size",
                "best_npv_yuan",
                "best_fitness_score_pct",
                "best_safety_score_pct",
                "best_economic_score_pct",
                "best_operation_safety_score_pct",
                "best_device_safety_score_pct",
                "best_fitness_compromise_cost",
                "best_score_strategy_id",
                "best_score_power_kw",
                "best_score_energy_kwh",
