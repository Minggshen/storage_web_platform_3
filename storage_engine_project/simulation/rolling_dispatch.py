                ...
                network_trace.append(
                    {
                        ...
                        "opendss_validated": meta.get("opendss_validated"),
                        "opendss_compile_mode": meta.get("opendss_compile_mode"),
                        "opendss_fallback_used": meta.get("opendss_fallback_used"),
                        "opendss_fallback_reason": meta.get("opendss_fallback_reason"),
                        "opendss_master_dss_path": meta.get("opendss_master_dss_path"),
                        "opendss_master_dss_sha256": meta.get("opendss_master_dss_sha256"),
                        "network_runtime_manifest_path": meta.get("network_runtime_manifest_path"),
                        "network_runtime_manifest_sha256": meta.get("network_runtime_manifest_sha256"),
                        ...
                        "target_phases": meta.get("target_phases"),
                        "storage_planned_charge_kw": meta.get("storage_planned_charge_kw"),
                        "storage_planned_discharge_kw": meta.get("storage_planned_discharge_kw"),
                        "storage_dispatch_net_kw": meta.get("storage_dispatch_net_kw"),
                        "storage_dispatch_state": meta.get("storage_dispatch_state"),
                        "storage_soc_fraction": meta.get("storage_soc_fraction"),
                        "storage_optimizer_sign_convention": meta.get("storage_optimizer_sign_convention"),
                        "storage_opendss_sign_convention": meta.get("storage_opendss_sign_convention"),
